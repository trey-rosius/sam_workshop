...
def create_user(user: {}):
    user = {"id":scalar_types_utils.make_id(),"age": 30, "country": "Cameroon", "favouriteMeal": "Achu", "firstName": "Rosius", "lastName": "Ndimofor Ateh", "village": "Akum"}
...
def update_user(input: {}):
    if input is None:
        input = {}
    return updateUserAccount(input)
